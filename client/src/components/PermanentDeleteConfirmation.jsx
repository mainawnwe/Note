...
const PermanentDeleteConfirmation = ({ 
  isOpen, 
  onClose, 
  onConfirm, 
  noteTitle = "this note",
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className={`text-sm mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'} italic`}>
              This action cannot be undone. The note will be completely removed from your account.
            </p>
          </div>
        </div>
...
export default PermanentDeleteConfirmation;