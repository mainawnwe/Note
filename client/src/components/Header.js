          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <div className={`p-2 rounded-lg transition-all duration-300 group-hover:scale-105 ${
                  darkMode ? 'bg-amber-600 shadow-amber-900/50' : 'bg-amber-500 shadow-amber-400/50'
                } shadow-lg`}>
                  <img
                ...
                <h1 className={`text-xl font-bold hidden md:block bg-gradient-to-r ${
                  darkMode ? 'from-amber-400 to-amber-300' : 'from-amber-600 to-amber-500'
              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <div
                    ref={menuRef}
                    className={`absolute top-full left-0 mt-2 w-64 rounded-xl shadow-xl z-50 max-h-[calc(100vh-5rem)] overflow-auto transition-all duration-200 origin-top ${
                      darkMode 
                  ...
                  >
                    <nav className="flex flex-col py-2">
                      {menuItems.map((item) => (
                        <button
                          key={item.id}
                          className={`flex items-center space-x-3 px-4 py-3 focus:outline-none transition-colors duration-150 ${
                            darkMode 
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                ...
                >
                  <div className={`bg-gradient-to-br rounded-full w-8 h-8 flex items-center justify-center text-white font-medium shadow-md transition-transform duration-300 hover:scale-105 ${
                    darkMode ? 'from-amber-500 to-amber-600' : 'from-amber-400 to-amber-500'
                  }`}>
                ...
                {profileOpen && (
                  <div
                    ref={profileRef}
                    className={`absolute top-full right-0 mt-2 w-64 rounded-xl shadow-xl z-50 overflow-hidden transition-all duration-200 origin-top ${
                      darkMode 
                  ...
                  >
                    <div className={`p-4 border-b ${
                      ...
                      <div className="flex items-center space-x-3">
                        <div className={`bg-gradient-to-br rounded-full w-12 h-12 flex items-center justify-center text-white font-medium shadow-lg ${
                          darkMode ? 'from-amber-500 to-amber-600' : 'from-amber-400 to-amber-500'
                        }`}>
                          {user?.name?.charAt(0).toUpperCase() || 'U'}
                        </div>
